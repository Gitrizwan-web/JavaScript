...
// let name = "Rizwan Fahim"
// let age = " 18 year's old "
...
// let email="My email adress in rizwanfahim004@gmail.com"
// alert(email)
// ***************Question7********************
...
// let qoute = "You have visited this site N times."
// alert(qoute)
...
//*************** */ Question1*************
// let letiable1 = "Hello, World!";
// let letiable2 = "Testing...";
// let letiable3 = 42;
...
// *********************Question3********
//    let n1 = "Number", n2="$",n3="_.",n4 = "letter " , n5=  5  ,n6= "Sensitive". n7="Keyword."
//    document.write("<h1>Rules for naming JS letiables<h1/>")
//    document.write("letiable names can only contain.",n1 ," and ",n2," and ",n3,"</br>")
//    document.write("letiables must begin with a ",n4," , ",n5,"or",n3 ," For example $name, _name or name </br>") 
//    document.write ("letiable names are case ",n6,"<br/>")
//    document.write("letiable names should not be JS",n6)
...
// document.write(`${celsius_temperature}°C is ${fahrenheit_temperature}°F </br>`);
// fahrenheit_temperature = 77;
// celsius_temperature = (fahrenheit_temperature - 32) * 5/9;
// document.write(`${fahrenheit_temperature}°F is ${celsius_temperature}°C`);
...
//     alert("False");
// }
// a. An alert message with text "given condition for variable a is true" will be displayed.

// b. No alert message will be displayed.

// c. Three alert messages with text "condition 2 is true", "condition 3 is true", and "condition 4 is true" will be displayed.

// d. An alert message with text "The cost equals" will be displayed.

// e. An alert message with text "True" will be displayed. No alert message with text "False" will be displayed
